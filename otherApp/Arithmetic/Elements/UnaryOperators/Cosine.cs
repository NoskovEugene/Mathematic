...
// Type: Arithmetic.Elements.UnaryOperators.Cosine
...
namespace Arithmetic.Elements.UnaryOperators
{
  ...
  {
    public override string Text => "COS";

    public Cosine() => this.Priority = 4;

    public override object Clone() => (object) this.Clone<Cosine>();

    public override double Invoke(double value) => Math.Cos(value);
