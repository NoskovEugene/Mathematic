...
// Type: Arithmetic.Elements.UnaryOperators.Actions
...
namespace Arithmetic.Elements.UnaryOperators
{
  ...
  {
    public static Dictionary<ElementTypeEnum, Func<TreeElement, double>> Action = new Dictionary<ElementTypeEnum, Func<TreeElement, double>>()
    {
      {
